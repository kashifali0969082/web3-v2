...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // We should also clean up other YouTube-related resources
      // Remove any remaining YouTube iframe API scripts
  ...
  // const level = 12;
  // Function to scroll to wallet section when wallet link is clicked
  ...
  const renderSidebar = () => {
    return (
      <aside
        className={`bg-gray-900 border-r border-gray-800 h-screen fixed lg:relative w-64 ${
      ...
      <div className="flex h-full">
        ...
        <main className="flex-1 h-screen overflow-y-auto smooth-scroll">
          ...
          <div className="hidden lg:block">
            <ErrorBoundary>
              <DashboardHeader onDisconnect={handleDisconnect} />
            </ErrorBoundary>
          </div>
                        ...
                        <li className="flex items-center">
                          <Check
                            className={`w-4 h-4 mr-2 ${
                              level >= 2 ? "text-green-400" : "text-gray-600"
                            }`}
                          />
                          Friend Connections
                        </li>
                    ...
                    >
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-center">
                          <Check
                            className={`w-4 h-4 mr-2 ${
                              level >= 3 ? "text-green-400" : "text-gray-600"
                            }`}
                          />
                          Video Calling
                        </li>
                    ...
                    >
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-center">
                          <Check
                            className={`w-4 h-4 mr-2 ${
                              level >= 4 ? "text-green-400" : "text-gray-600"
                            }`}
                          />
                          Live Streaming
                        </li>
                    ...
                    >
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-center">
                          <Check
                            className={`w-4 h-4 mr-2 ${
                              level >= 5 ? "text-green-400" : "text-gray-600"
                            }`}
                          />
                          Pro Package Access
                        </li>
